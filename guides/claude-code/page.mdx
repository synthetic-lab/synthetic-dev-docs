...
For easier access, create a `synclaude` alias that launches Claude Code with Synthetic configuration:

```bash
# Add to ~/.bashrc or ~/.zshrc
alias synclaude='ANTHROPIC_BASE_URL=https://api.synthetic.new/anthropic \\
