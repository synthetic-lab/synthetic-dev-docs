...
For multimodal image input, you can send images in your message's `content`
array as follows:
...
Image URLs can either be real URLs to files available over the internet, or
base64-encoded strings containing the image data in the standard format:
