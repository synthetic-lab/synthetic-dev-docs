...
import { formatPrice } from "@/app/(sidebar)/billing/price-data-layer";
import { formatK } from "@/app/(sidebar)/billing/money";
...
<Alert className="mb-4">
  ...
  <AlertDescription>
    <p><strong>Always-On</strong>, <strong>LoRA</strong>, and <strong>Embeddings</strong> models are included in every <SubdomainLink href="/billing/subscription"><strong>subscription</strong></SubdomainLink>.</p>
  </AlertDescription>
</Alert>

## Always-On Models

These models are included in all Standard and Pro <SubdomainLink href="/billing/subscription">subscriptions</SubdomainLink>.
Per-token pricing is also available with <SubdomainLink href="/billing">usage-based billing</SubdomainLink>.
