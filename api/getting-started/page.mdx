...
<Alert className="mb-4">
  ...
  <AlertDescription>
    <p>Check out the sidebar for step-by-step tutorials on setting up coding agents, including [Octofriend](/docs/guides/octofriend)!.</p>
  </AlertDescription>
</Alert>
...
console.log(completion.choices[0].message.content);`,
    ...
    title: "curl",
    language: "bash",
    source: `curl -X POST https://api.synthetic.new/v1/chat/completions \\
...
models.data.forEach(model => {
  console.log(model.id);
    ...
    title: "curl",
    language: "bash",
    source: `curl https://api.synthetic.new/v1/models \\
  -H "Authorization: Bearer \${SYNTHETIC_API_KEY}"`,
  }]}
/>
...
- **User Guides**: See how to set up agents like [Octofriend](/docs/guides/octofriend), [Claude Code](/docs/guides/claude-code), and more!
...
- **Monitor Usage**: Track your API usage on your <SubdomainLink href="/billing">Billing</SubdomainLink> page.
...
3. Ask for help on our <SubdomainLink href="/discord">Discord Server</SubdomainLink>!
