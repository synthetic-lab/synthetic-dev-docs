...
<Alert className="mb-4">
  ...
  <AlertDescription>
    <p>Check out our **Guides** for step-by-step tutorials on setting up various frontends and development tools with Synthetic.</p>
  </AlertDescription>
</Alert>
...
- **Monitor Usage**: Track your API usage on your <SubdomainLink href="/billing/subscriptions">Subscription</SubdomainLink> page.
